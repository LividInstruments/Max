...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 502.75, 151.5, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 398.5, 222.5, 0.0, 0.0 ],
					"text" : "r port"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 448.5, 154.5, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 398.5, 154.5, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 79.25, 127.5, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 13.25, 641.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 235.25, 568.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 527.75, 463.5, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 13.25, 253.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 105.25, 412.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 322.25, 321.0, 0.0, 0.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 128.0, 163.199997, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 140.0, 181.0, 91.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 70.0, 161.0, 32.5, 18.0 ],
									"text" : "t l b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 290.0, 236.0, 32.5, 18.0 ],
									"text" : "<< 0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 70.0, 206.0, 245.5, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 125.0, 301.0, 39.0, 18.0 ],
									"text" : "zl sum"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 125.0, 281.0, 113.5, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 257.0, 238.0, 32.5, 18.0 ],
									"text" : "<< 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 120.0, 241.0, 32.5, 18.0 ],
									"text" : "<< 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 155.0, 241.0, 32.5, 18.0 ],
									"text" : "<< 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 190.0, 241.0, 32.5, 18.0 ],
									"text" : "<< 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 225.0, 241.0, 32.5, 18.0 ],
									"text" : "<< 2"
								}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 577.5, 417.889526, 0.0, 0.0 ],
					"rounded" : 2.0,
					"text" : "Enc-relative",
					"texton" : "Enc-relative",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 454.5, 414.0, 0.0, 0.0 ],
					"rounded" : 2.0,
					"text" : "Enc-absolute",
					"texton" : "Enc-absolute",
					"textoncolor" : [ 0.0, 0.0, 0.0, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 481.25, 435.0, 0.0, 0.0 ],
					"rounded" : 2.0,
					"text" : "Button-toggle",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 424.25, 317.0, 0.0, 0.0 ],
					"text" : "r port"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 474.25, 291.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 474.75, 348.0, 0.0, 0.0 ],
					"text" : "ctlout 1 16"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 429.75, 305.5, 132.0, 44.0 ],
					"presentation_rect" : [ 474.25, 247.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.75, 151.5, 237.0, 63.0 ],
					"presentation_rect" : [ 198.25, 114.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 16.0,
					"id" : "obj-65",
					"items" : [ "AU DLS Synth 1", ",", "IAC Driver Bus 1", ",", "from Max 1", ",", "from Max 2", ",", "Base Controls", ",", "Base Port 2", ",", "Cntrl_r Controls", ",", "Cntrl_r Port 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
,
					"patching_rect" : [ 430.25, 652.889526, 55.0, 25.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.25, 624.0, 149.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 440.0, 127.0, 0.0, 0.0 ],
					"text" : "r port"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 514.0, 189.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 48.0, 171.0, 0.0, 0.0 ],
					"text" : "r port"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 137.0, 269.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 283.0, 439.0, 0.0, 0.0 ],
					"text" : "r port"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 333.0, 413.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 333.0, 390.0, 0.0, 0.0 ],
					"text" : "settings channel \n(ring mode)"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 303.0, 182.0, 0.0, 0.0 ]
				}
