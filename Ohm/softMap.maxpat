...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1060.0, 339.0, 100.0, 21.0 ],
					"presentation" : 1,
...
,
		"dependency_cache" : [ 			{
				"name" : "thru.maxpat",
				"bootpath" : "/Volumes/Satellite/gitbins/monomodular/aumhaa_blocks/steppr",
				"patcherrelativepath" : "../../monomodular/aumhaa_blocks/steppr",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
